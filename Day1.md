...
- [x] I can open a Linux terminal and recognize the shell prompt
...
Today I learned how to set up WSL, install Python, Git and uv, connect VS Code to Linux, navigate the terminal, and connect GitHub with SSH. It was confusing at first when commands didn't work but I figured it out step by step.